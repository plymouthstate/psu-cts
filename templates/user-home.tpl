...
{/box}
{box size ="5" title="Pending Equipment Reservations"}
...
{box size="5" title="Equipment Reservation History"}

		<p class="center"><a class="button" href="{$PHP.BASE_URL}/history/">View History</a></p>

		<p>View your equipment Reservation History to see all of your completed reservations since August 1st, 2007.</p>
